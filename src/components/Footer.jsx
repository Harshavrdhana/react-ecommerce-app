...
const tweetList = [
    {
        iconName: 'icofont-twitter',
        desc: <p>Aminur islam <br /><a href="#">@ShopCart Greetings!  #HTML_Template</a> <br />Grab your item, 50% Big Sale Offer !!</p>,
    },
    {
        iconName: 'icofont-twitter',
        desc: <p>Somrat islam <br /><a href="#">@ShopCart Hey! #HTML_Template</a> <br />Grab your item, 50% Big Sale Offer !!</p>,
    },
]
